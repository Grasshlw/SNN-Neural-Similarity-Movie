...
def get_args():
    ...
    parser.add_argument("--dataset", default="UCF101_subset", type=str, choices=["UCF101_subset", "UCF101_random"], help="name of dataset")
    parser.add_argument("--data-path", default="/dataset/UCF101/UCF-101-frame/", help="dataset path")
    ...
    parser.add_argument("--model-name", default="r_sew_resnet18", type=str, help="name of model to train")
    ...
    parser.add_argument("--output-path", default="/userhome/project/video_snn/logs", help="path to save outputs")
...
def load_UCF101(args):
    if "subset" in args.dataset:
        datasets = datasets_subset.UCF101OneClip
    elif "random" in args.dataset:
        datasets = datasets_subset.UCF101RandomClip
    print("Loading data...")
...
def main(args):
    ...
    train_set, test_set, train_sampler, test_sampler = load_UCF101(args)
